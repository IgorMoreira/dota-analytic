...
plt.xticks(rotation=45, ha='right', fontsize=8)  # Rotaciona os rótulos do eixo x para facilitar a leitura
plt.style.use("dark_background")
plt.show()
...
# ax1.set_title('Top 5 combinações de pares por equipe (Radiant x Dire)')
...
ax1.set_xlabel('Combinação de Heróis')
ax1.set_ylabel('Quantidade de Partidas', color='black')
# ax1.set_title('Top 5 combinações de trios por equipe (Radiant x Dire)')
